...
public class LongestIncreasingSubsequence {
    public int lengthOfLIS(int[] nums) {
        ...
        for (int num : nums) {
            // Use custom binary search to find the position of num in dp array
    ...
    public static void main(String[] args) {
        ...
        // Example 1
        int[] nums1 = {10, 9, 2, 5, 3, 7, 101, 18};
        System.out.println("Example 1: " + solution.lengthOfLIS(nums1)); // Output: 4

        // Example 2
        int[] nums2 = {0, 1, 0, 3, 2, 3};
        System.out.println("Example 2: " + solution.lengthOfLIS(nums2)); // Output: 4

        // Example 3
        int[] nums3 = {7, 7, 7, 7, 7, 7, 7};
        System.out.println("Example 3: " + solution.lengthOfLIS(nums3)); // Output: 1
    }
}
